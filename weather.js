...
GLoc = {
    ...
    geoSuccess: function(position) {
        ...
        g.startPos = position;
        g.searchQuery = 'http://api.openweathermap.org/data/2.5/weather?lat=' + g.startPos.coords.latitude + '&lon=' + g.startPos.coords.longitude + '&APPID=bc9400a8333d303bf0c5377a91b0989a';
...
WeatherInfo = {
    ...
    getWeatherData: function(searchQuery) {
        if (w.searchLocationInput.val() !== '') {
            w.searchQuery = 'http://api.openweathermap.org/data/2.5/weather?q=' + w.searchLocationInput.val() + '&APPID=bc9400a8333d303bf0c5377a91b0989a';
